...
func GetMemoryInfo() *linux.MemInfo {
	...
	if err != nil {
		log.Printf("Error reading the memory info from /proc/meminfo")
...
func GetDiskInfo() *linux.Disk {
	...
	if err != nil {
		log.Printf("Error reading the disk info from /")
		return &linux.Disk{}
	}
	return diskstats
}
...
func GetCpuStats() *linux.CPUStat {
	...
	if err != nil {
		log.Printf("Error reading stats from /proc/stat")
...
func GetLoadAvg() *linux.LoadAvg {
	...
	if err != nil {
		log.Printf("Error reading average load from /proc/loadavg")
